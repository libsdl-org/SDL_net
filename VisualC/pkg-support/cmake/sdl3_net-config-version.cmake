...
if(NOT EXISTS "${CMAKE_CURRENT_LIST_DIR}/../include/SDL3_net/SDL_net.h")
    message(AUTHOR_WARNING "Could not find SDL3_net/SDL_net.h. This script is meant to be placed in a CMake subfolder of SDL3_net-devel-3.x.y-VC")
    return()
endif()

file(READ "${CMAKE_CURRENT_LIST_DIR}/../include/SDL3_net/SDL_net.h" _sdl_net_h)
